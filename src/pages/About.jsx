...
function About() {
  return (
    <div className="page-container">
      <h2 class="about-head">About Winx Design Agency</h2>
      <p class="abt-content">Welcome to Winx Design Agency, where creativity meets innovation. We are a team of passionate designers and developers dedicated to delivering exceptional digital experiences.</p>

      <p class="abt-content">Our mission is to empower businesses, both big and small, by providing cutting-edge design solutions that captivate audiences and drive results. With a focus on user-centric design, we craft unique strategies tailored to meet the specific needs of each client.</p>
